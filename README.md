# Facturation Atelier — v1.4.9 (STABLE)
...
## Correctifs v1.4.9
- Validation **Marque/Modèle** : le bouton **Suivant** s’active dès que tu choisis une marque (et un modèle).
- Cache : nouveau nom de cache Service Worker pour éviter d’utiliser une ancienne version.
